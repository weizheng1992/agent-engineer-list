...
const supervisorNode = async (state: SoftwareTeamState) => {
  return {
    messages: [{
      sender: "Supervisor",
...
const architectNode = async (state: SoftwareTeamState) => {
  return {
...
const developerNode = async (state: SoftwareTeamState) => {
...
const testerNode = async (state: SoftwareTeamState) => {
...
const reviewerNode = async (state: SoftwareTeamState) => {
  return {
